...
import online.danbao.studentinfoapp.R;
import online.danbao.studentinfoapp.bean.StudentInfoEntities;
import online.danbao.studentinfoapp.db.DBAdapter;
import online.danbao.studentinfoapp.receiver.MyBroadcastReceiver;

import static online.danbao.studentinfoapp.db.DBAdapter.S_INFO_TABLE_NAME;
...
public class OtherInfoActivity extends AppCompatActivity {
    ...
    private StringBuilder getSpecialSkillStr() {
        ...
        if (computer.isChecked()) {
            specialSkillStr.append(computer.getText().toString()).append("、");
        }
