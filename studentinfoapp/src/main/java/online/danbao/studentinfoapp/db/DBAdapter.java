package online.danbao.studentinfoapp.db;
...
import online.danbao.studentinfoapp.App;
import online.danbao.studentinfoapp.utils.FileUtils;
...
public class DBAdapter extends SQLiteOpenHelper {
     ...
     * 数据库文件名
     */
    private static final String DB_NAME = "student_info_database.db";
    /**
     * 身份证前6为对应位置的数据库表
     */
